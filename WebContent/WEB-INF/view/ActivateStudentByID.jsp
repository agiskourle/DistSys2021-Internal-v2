...
<link
	...
	rel="stylesheet">
<meta charset="UTF-8">
<title>Student Activation</title>
</head>
<style>
...
<body>
	<div class="card">
		...
		<form action="activateStudentForm" method="GET">
			<label for="id"><b>Activate Student with ID :</b></label> <input
				type="text" name="id" placeholder="Enter Student ID" required>
